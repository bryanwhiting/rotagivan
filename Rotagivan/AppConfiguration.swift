...
private indirect enum ConfigurationValue: Codable {
    ...
    func validate(key: String = "", path: String = "config") throws {
        ...
        case .object(let values):
            ...
            case "appExplorer": allowed = "actionBindings defaultMode favorites holdShortcut holdLayers theme animationsEnabled centerCursorOnAppSwitch slotCount windowManager swipeDirection voiceAutoDecide"
