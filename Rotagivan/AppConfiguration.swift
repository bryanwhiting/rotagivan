...
private indirect enum ConfigurationValue: Codable {
    ...
    func validate(key: String = "", path: String = "config") throws {
        ...
        case .object(let values):
            ...
            case "appExplorer": allowed = "actionBindings defaultMode favorites holdShortcut holdLayers theme animationsEnabled centerCursorOnAppSwitch slotCount windowManager swipeDirection invertPickerDirection voiceAutoDecide voiceAutoStart"
            case "windowManager": allowed = "actionBindings layout layers shortcuts favorites slotCount"
            case "layers", "holdLayers": allowed = "builtIn actionBindings id name position holdShortcut favorites windowLayout slotCount activation windowTilesConfigured launchShortcut appBundleID appName"
            ...
            case "profileGestures", "appleLayerGestures": allowed = "gestures oneFingerTap twoFingerTap oneFingerShortcut twoFingerShortcut oneFingerDoubleTap twoFingerDoubleTap oneFingerDoubleShortcut twoFingerDoubleShortcut doubleTapSwipe singleTapSwipe oneFingerTapTwoFingerSwipe twoFingerSingleTapSwipe twoFingerDoubleTapSwipe twoFingerSwipe oneFingerTripleTap twoFingerTripleTap oneFingerTripleShortcut twoFingerTripleShortcut"
            case "doubleTapSwipe", "singleTapSwipe", "oneFingerTapTwoFingerSwipe", "twoFingerSingleTapSwipe", "twoFingerDoubleTapSwipe", "twoFingerSwipe": allowed = "enabled swipeWindow swipeDistance fastSwipeDuration appExplorerDirections left right up down topLeft topRight bottomLeft bottomRight"
