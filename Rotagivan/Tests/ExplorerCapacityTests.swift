...
@main struct ExplorerCapacityTests {
    static func main() throws {
        ...
        var invalid = base; invalid.slotCount = 6; precondition(!invalid.hasValidFavorites)
        ...
        print("Explorer capacities passed: 4/8/12/16 sectors, every selection, dead seams, legacy bindings, lossless resizing, nested recents, toggle layers and invalid imports.")
    }
}
