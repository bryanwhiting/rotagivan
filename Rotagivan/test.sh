...
xcrun swiftc -j 4 Rotagivan/CredentialWorker.swift Rotagivan/VaultCrypto.swift Rotagivan/Tests/VaultCryptoTests.swift -framework Security -o "$test_dir/VaultCryptoTests"
