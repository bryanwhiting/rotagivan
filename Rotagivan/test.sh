...
for test in CursorResponseTests CursorGainTests CursorTelemetryTests ScrollResponseTests ConfigurationProfileTests PointerProfileTests TapCalibrationSettingsTests ExplorerTileLayerTests ExplorerTransferTests WindowGroupTests ReservedGroupTests UnifiedBindingScopeTests; do
...
xcrun swiftc Rotagivan/TrackpadInputRouting.swift Rotagivan/ExplorerPointerLock.swift \
...
xcrun swiftc "${common[@]}" Rotagivan/WindowTiling.swift Rotagivan/MediaControls.swift Rotagivan/Tests/ExplorerLayerMediaTests.swift \
