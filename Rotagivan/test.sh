...
for test in CursorResponseTests CursorGainTests CursorTelemetryTests ScrollResponseTests ConfigurationProfileTests PointerProfileTests TapCalibrationSettingsTests ExplorerTileLayerTests ExplorerTransferTests WindowGroupTests ReservedGroupTests; do
